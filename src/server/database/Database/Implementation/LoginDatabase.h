...
enum LoginDatabaseStatements : uint32
{
    ...
    */
    ...
    LOGIN_UPD_BATTLE_PAY_CLAIM_ITEMS,

    // BNet Friends
    LOGIN_SEL_BNET_BATTLETAG,
    LOGIN_SEL_BNET_ACCOUNT_ID_BY_BATTLETAG,
    LOGIN_UPD_BNET_BATTLETAG,
    LOGIN_SEL_BNET_FRIENDS,
    LOGIN_INS_BNET_FRIEND,
    LOGIN_DEL_BNET_FRIEND,
    LOGIN_SEL_BNET_INVITATIONS_RECEIVED,
    LOGIN_SEL_BNET_INVITATIONS_SENT,
    LOGIN_INS_BNET_INVITATION,
    LOGIN_DEL_BNET_INVITATION,
    LOGIN_SEL_BNET_INVITATION_BY_ID,

    // Game Time
    LOGIN_SEL_BNET_GAME_TIME,
    LOGIN_UPD_BNET_GAME_TIME,

    // Parental Controls
    LOGIN_SEL_PARENTAL_CONTROLS,
    LOGIN_UPD_PARENTAL_CONTROLS_ENABLED,
    LOGIN_UPD_PARENTAL_CONTROLS_SCHEDULE,

    // Arena Tournament subscription
    LOGIN_SEL_BNET_TOURNAMENT,
    LOGIN_UPD_BNET_TOURNAMENT,

    // Trial Account
    LOGIN_SEL_BNET_TRIAL,
    LOGIN_UPD_BNET_TRIAL,
    LOGIN_SEL_BNET_FRIEND_CHECK,
