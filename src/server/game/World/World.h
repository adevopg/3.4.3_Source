...
enum WorldBoolConfigs
{
    ...
    CONFIG_FEATURE_SYSTEM_CUSTOMER_SUPPORT_SYSTEM_BROWSER_ENABLED,
    CONFIG_FEATURE_SYSTEM_VOICE_CHAT_ENABLED,
    CONFIG_GAME_TIME_REQUIRED,
    CONFIG_ARENA_TOURNAMENT_REALM,
