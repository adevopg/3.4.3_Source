...
void World::LoadConfigSettings(bool reload)
{
    ...
    m_int_configs[CONFIG_BATTLE_PAY_PROMOTION] = sConfigMgr->GetIntDefault("DisplayPromotion.PromotionID", 0);
...
void World::SetInitialWorldSettings()
{
    ...
    TC_LOG_INFO("server.loading", "Loading Personal ArenaTeams...");
    sArenaTeamMgr->LoadPersonalArenaTeams();
