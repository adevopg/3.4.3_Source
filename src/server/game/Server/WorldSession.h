...
namespace WorldPackets
{
    ...
    namespace Battleground
    {
        ...
        class BattlemasterJoinSkirmishArena;
    ...
    {
        class LearnTalent;
        class LearnPetTalent;
        class LearnPetPreviewTalents;
...
class TC_GAME_API WorldSession
{
    ...
    public:                                                 // opcodes handlers
        ...
        void HandleInspectPvPOpcode(WorldPackets::Inspect::InspectPvP& inspect);
        void HandleRequestHonorStatsOpcode(WorldPackets::Inspect::RequestHonorStats& inspect);
        ...
        // 335 AH
        void HandleAuctionListPendingSales(WorldPackets::AuctionHouse::AuctionListPendingSales& pendingSales);
        ...
        void HandleLearnPetTalentOpcode(WorldPackets::Talent::LearnPetTalent& packet);
        void HandleLearnPetPreviewTalentsOpcode(WorldPackets::Talent::LearnPetPreviewTalents& packet);
        ...
        void HandleBattlemasterJoinSkirmishArena(WorldPackets::Battleground::BattlemasterJoinSkirmishArena& packet);
        ...
        void HandleRequestConquestFormulaConstants(WorldPackets::Battleground::RequestConquestFormulaConstants& packet);
        ...
        void HandleStableSwapPet(WorldPackets::NPC::StableSwapPet& packet);
        ...
        // Arena
        void HandleArenaTeamRosterOpcode(WorldPackets::Arena::ArenaTeamRoster& arenaTeamRoster);
