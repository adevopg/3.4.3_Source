...
namespace Battlepay
{
    constexpr uint32 g_CurrencyPrecision = 10000;
...
public:
    ...
    void AlreadyOwnProduct(WorldPackets::BattlePay::Product& product) const;
    void SavePurchase(const Battlepay::Purchase& purchase, bool claimed);
    void ProcessDelivery(const Battlepay::Purchase& purchase, bool onLogin);
